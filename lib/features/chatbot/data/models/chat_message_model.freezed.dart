...
class _$ChatMessageModelImpl implements _ChatMessageModel {
  ...
  @override
  String toString() {
    return 'ChatMessageModel(id: $id, userId: $userId, content: $content, isUser: $isUser, timestamp: $timestamp, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, userId, content, isUser, timestamp, status);
...
abstract class _ChatMessageModel implements ChatMessageModel {
  const factory _ChatMessageModel(
      ...
      final String status}) = _$ChatMessageModelImpl;
